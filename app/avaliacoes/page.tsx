      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="font-bebas text-3xl sm:text-4xl text-slate-900 tracking-wider leading-none flex items-center gap-2">
            <Award className="w-8 h-8 text-[#1A6B2E]" />
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-[4px] bg-[#1A6B2E]/10 border border-[#1A6B2E]/30 flex items-center justify-center font-bebas text-2xl text-[#1A6B2E] shrink-0">
                      ...
                      <div className="p-2 rounded-[4px] bg-amber-50 border border-amber-200 text-center shrink-0">
                    ...
                    <div className="grid grid-cols-2 gap-2 bg-slate-50 p-3 rounded-[4px] border border-slate-200 text-[11px]">
                    ...
                    <div className="text-[10px] text-slate-500 flex justify-between items-center pt-2 border-t border-slate-100 font-mono">
                      ...
                      <span className="text-[#1A6B2E] font-bold">✓ Homologado</span>
                    </div>
                  </div>
                )
              })}
        ...
        <div className="card-light p-6 space-y-4">
          <div className="border-b border-slate-100 pb-3">
            <h3 className="font-bebas text-2xl text-slate-900 tracking-wider leading-none flex items-center gap-2">
              <Sparkles className="w-5 h-5 text-[#1A6B2E]" />
          ...
          <form action={createEvaluationAction} className="space-y-4">
            ...
            <div className="space-y-3 pt-2">
              <span className="text-xs font-bold uppercase tracking-wider text-[#1A6B2E] block border-b border-slate-100 pb-1">
