  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link
          href="/alunos/novo"
          className="px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs uppercase tracking-wider rounded-[6px] flex items-center gap-2 shadow-xs transition-all shrink-0 cursor-pointer"
        >
      ...
      <div className="card-light p-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        <form method="GET" className="flex-1 flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-[6px] px-3 py-2">
      ...
      {students.length === 0 ? (
        <div className="card-light py-16 text-center space-y-3">
          ...
          <div className="pt-2">
            <Link
              href="/alunos/novo"
              className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold uppercase tracking-wider rounded-[6px] inline-flex items-center gap-1.5 shadow-xs"
            >
                  ...
                  return (
                    <tr key={st.id} className="hover:bg-slate-50/80 transition-colors">
                        ...
                        {st.guardian ? (
                          <div>
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="text-[11px] text-emerald-700 font-semibold hover:underline flex items-center gap-1 font-mono"
                            >
                      ...
                      <td className="px-5 py-4 text-right">
                        <Link
                          href={`/alunos/${st.id}`}
                          className="px-3 py-1.5 bg-slate-100 hover:bg-emerald-50 hover:text-emerald-900 text-slate-700 border border-slate-200 rounded text-xs font-bold uppercase tracking-wider inline-flex items-center gap-1 transition-all"
                        >
